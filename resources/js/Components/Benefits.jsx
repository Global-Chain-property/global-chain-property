    ...
    <section id='benefits' className="py-20 md:py-32 bg-white">
      <div className="container mx-auto px-6 md:px-10">
        ...
        <div className="flex justify-center mb-4">
          <div className="h-1 w-60 bg-gold rounded-full animate-fade-in-up duration-500" />
        </div>
        <h2 className="text-4xl md:text-5xl font-extrabold text-center text-navy mb-4">
          Why Choose <span className="text-gold">GlobalChain?</span>
        </h2>
            ...
            return (
              ...
              <div 
                ...
                className={`
                  ...
                  shadow-xl shadow-gold/70 hover:shadow-2xl hover:border-gold 
              ...
              >
                ...
                <div className="mb-4 flex items-center h-12 w-12 rounded-full bg-gold/20">
                  <BenefitIcon className="h-6 w-6 text-gold mx-auto" strokeWidth={2.5} />
                </div>
