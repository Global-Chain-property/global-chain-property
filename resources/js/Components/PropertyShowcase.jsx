...
const PropertyShowcase = () => {
  return (
    // Background is clean white/offwhite
    <section id='properties' className="py-20 md:py-28 bg-offwhite/40">
      <div className="container mx-auto px-6 md:px-10">

        {/* Section Header */}
        <div className="flex justify-center mb-4">
          <div className="h-1 w-60 bg-gold mt-[-20px] rounded-full animate-fade-in-up duration-500" />
        </div>
              ...
              <div className="p-6">
                ...
                <div className="space-y-2 text-sm mb-6">
                  <p className="flex justify-between font-medium">
                    ...
                    <span className="text-navy font-semibold">{formatCurrency(property.value)}</span> 
                  </p>
                ...
                <button 
                  className="
                    w-full bg-navy text-white font-semibold 
                    py-3 rounded-lg 
                    transition duration-300 ease-in-out 
                    hover:bg-gold hover:shadow-lg hover:shadow-gold/30
                  "
                >
                  View Details
                </button>
        ...
        <div className="text-center mt-16">
          <button 
            className="
              text-lg border-2 border-navy text-navy font-semibold 
              py-3 px-8 rounded-lg 
              transition duration-300 ease-in-out hover:bg-navy hover:text-white
            "
          >
