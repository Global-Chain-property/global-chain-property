          ...
          {faqData.map((item, index) => (
            <div 
              ...
              className={`
                ...
                animate-fade-in-up
                ${openIndex === index 
                  ? 'shadow-xl shadow-gold/50 border-gold' // Active/Glow State
                  : 'hover:shadow-lg hover:border-gold/70' // Hover State
                }
              `}
            ...
            >
              ...
              <div 
                className="flex justify-between items-center p-6 text-xl font-semibold text-navy"
                onClick={() => toggleFAQ(index)}
              >
                {item.question}
                <ChevronDown 
                  className={`
                    h-6 w-6 text-gold transition-transform duration-300
