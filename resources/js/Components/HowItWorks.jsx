  ...
  return (
    ...
    <section id='how-it-works' className="py-20 md:py-32 bg-white">
      <div className="container mx-auto px-6 md:px-10">
        ...
        {/* Title */}
        <h2 className="text-4xl md:text-5xl font-extrabold text-center text-navy mb-6">
          Own Property the <span className="text-gold">Modern Way</span>
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {steps.map((step, index) => (
            ...
            <div 
              key={index} 
              className={`
                bg-offwhite p-8 rounded-xl shadow-xl shadow-gold/40  hover:shadow-2xl transition duration-500
            ...
            >
              ...
              {/* Icon Container (Large, Gold Accent) */}
              <div className="text-8xl text-gold mb-6 flex justify-center items-center h-16 w-16 rounded-full bg-gold/10">
                {step.icon}
              </div>
