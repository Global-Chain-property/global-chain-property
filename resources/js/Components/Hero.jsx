  ...
  return (
    ...
    <section className="relative w-full h-screen flex items-center justify-center pt-20"> 
      ...
      <div className="relative z-10 text-center max-w-4xl px-6 md:px-0">
        ...
        <h1 
          className="
            text-6xl md:text-7xl font-extrabold text-offwhite
            mb-4 space-x-4
        ...
        <p 
          className="
            text-xl md:text-2xl text-offwhite font-light 
        ...
        >
          ...
          <button onClick={() => scrollToSection('how-it-works')}
            className="
              ...
              py-2 px-4 rounded-lg text-lg 
              transition duration-300 ease-in-out hover:bg-white/10 hover:border-gold
