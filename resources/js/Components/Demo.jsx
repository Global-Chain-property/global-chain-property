...
const Demo = () => {
  ...
  return (
    <section className="py-20 md:py-32 bg-offwhite/40">
      <div className="container mx-auto px-6 md:px-10">

        {/* Section Header */}
        <div className="flex justify-center mb-4">
          <div className="h-1 w-60 mt-[-20px] bg-gold rounded-full animate-fade-in-up duration-500" />
        </div>
        <h2 className="text-4xl md:text-5xl font-extrabold text-center text-navy mb-4">
          See How Easy It Is
        </h2>
        ...
        <div 
          className="max-w-4xl mx-auto p-8 lg:p-12 bg-offwhite rounded-xl shadow-2xl 
          border-t-4 border-gold transition duration-500 animate-fade-in-up"
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            
            {/* LEFT SIDE: Inputs */}
            <div>
              <h3 className="text-3xl font-bold text-navy mb-6">Your Investment Simulation</h3>
              ...
              <div className="mb-10">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  >
                    <MinusCircle className="h-6 w-6 text-navy" />
                  </button>
                  
                  {/* Amount Display */}
                  <p className="text-4xl font-extrabold text-gold w-32 text-center transition duration-300">
                  ...
                  <button 
                    onClick={() => handleInvestmentChange(1000)}
                    className="p-3 rounded-full bg-gold/20 hover:bg-gold/40 transition duration-300"
                  >
              ...
              <button 
                className="
                  w-full bg-gold text-white font-semibold 
            ...
            <div className="bg-white p-8 rounded-lg shadow-inner flex flex-col justify-center">
              <h3 className="text-2xl font-bold text-navy mb-6 border-b pb-3">Your Estimated Results</h3>
              
              {/* Ownership Percentage */}
              <div className="flex justify-between items-center py-3 border-b border-gray-100">
                <p className="text-lg text-gray-600">Your Ownership:</p>
                <p className="text-3xl font-extrabold text-navy transition-all duration-500">
                  {ownershipPercentage}%
                </p>
              </div>
              ...
              <div className="flex justify-between items-center py-3">
                ...
                <p className="text-3xl font-extrabold text-gold transition-all duration-500">
